    ...
    internal class Program
    {
        ...
        static void mlbCompetition()
        {
            ...
            try
            {
                ...
                // MLB Playoff 
                MlbCompetition.WriteICalCalender("https://statsapi.mlb.com/api/v1/schedule?sportId=1&startDate=2022-10-06&endDate=2022-11-10&hydrate=team(venue(timezone)),venue(timezone),gameInfo,seriesStatus,seriesSummary,gameData",
                                                  "MLB-2023-",
                                                  "Etc/UTC",
                                                  "MLB-Playoff-2023"
                                                 );
